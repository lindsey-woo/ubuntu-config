...
# Modified because Lindsey wants a different background. Old file saved at
# base16-default-dark-old.sh
# Ubuntu palette: https://design.ubuntu.com/brand/colour-palette/

color00="18/18/18" # Base 00 - Black
color01="ab/46/42" # Base 08 - Red
color02="cc/56/2b" # Base 0B - 90% Ubuntu Orange
color03="f7/ca/88" # Base 0A - Yellow
color04="cf/2b/85" # Base 0D - 40% Aubergine
...
color_foreground="de/db/d8" # 40% Warm Grey
color_background="2c/00/1e" # 90% Dark Aubergine
